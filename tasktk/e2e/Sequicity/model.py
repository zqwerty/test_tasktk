...
from reader import get_glove_matrix
from reader import CamRest676Reader, KvretReader, MultiWozReader
...
from metric import CamRestEvaluator, KvretEvaluator, MultiWozEvaluator
import logging
...
class Model:
    ...
    def interact(self):
        ...
        while True:
            ...
            u_input = cuda_(Variable(torch.from_numpy(u_input_np).long()))
            m_idx, z_idx, _ = self.m(mode='test', degree_input=None, z_input=None,
